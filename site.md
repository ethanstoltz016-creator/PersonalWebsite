...
<strong>Content to be included</strong>
  ...
  <br>
  <li>AI Usage on this project is only allowed with assitance in generating images and color paletes.  I would still recommend utilizing https://coolors.co/ or similar websites.</li>